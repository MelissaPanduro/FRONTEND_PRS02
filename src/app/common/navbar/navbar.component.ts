// Modifica el archivo navbar.component.ts 
...
export class NavbarComponent implements OnInit, OnDestroy {
  ...
  // Nuevos métodos para manejar las opciones del perfil sin navegación
  handleProfileClick(event: Event): void {
    event.preventDefault();
    console.log('Perfil clickeado - Funcionalidad por implementar');
  ...
  handleSettingsClick(event: Event): void {
    event.preventDefault();
    console.log('Configuración clickeada - Funcionalidad por implementar');
    // Cierra el menú después de hacer clic
    this.userMenuOpen = false;
  }
}